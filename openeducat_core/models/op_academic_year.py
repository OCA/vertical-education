        ...
        if self.term_structure == "two_sem":
                    ...
                    for term in res:
                        ...
                        for sub_term in self.academic_term_ids:
                            ...
                            vals = {
                                ...
                                "from_date": (sub_from_d + timedelta(days=day + 1)),
                                "to_date": (
                                    sub_from_d + timedelta(days=delta.days - 1)
                                ),
                            }
                            result.append(vals)
                            vals = {
                                "name": "Final Exam" + " " + str(final),
                                "from_date": sub_to_d,
                                "to_date": sub_to_d,
                            }
                            result.append(vals)
            ...
            for record in self:
                if not record.academic_term_ids:
                    ...
                    res = []
                    res.append(
                        {"name": "Semester 1", "from_date": from_d, "to_date": to_d}
                    )
