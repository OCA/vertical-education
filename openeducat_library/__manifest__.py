{   'application': True,
    ...
    'depends': ['account', 'base_automation', 'openeducat_activity', 'openeducat_parent'],
    'images': ['static/description/openeducat-library_banner.jpg'],
    'installable': True,
    'license': 'AGPL-3',
